...
import { getMonsterAvatar } from '../../../../img/imgFunctions';
  ...
  return (
    <Grid item xs={12} md={4}>
      <Grid container className={classes.opponent}>
        ...
        <Grid item xs={6} className={classes.monsterAvatarGrid}><img src={getMonsterAvatar(monster?.type)} className={classes.monsterAvatar} alt="avatar" /></Grid>

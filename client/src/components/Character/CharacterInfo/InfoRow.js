            ...
            case 'level':
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        <Typography whiteSpace="nowrap" variant="h6"> {shouldDisplayName ? 'Level: ' + currentValue : currentValue} </Typography>
                    </Grid>
                )
                ...
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        {shouldDisplayBar
                            ...
                            : <Typography whiteSpace="nowrap" variant="h6"> {shouldDisplayName ? 'HP:' + currentValue : currentValue} </Typography>
                        }
                    </Grid>
                )
                ...
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        {shouldDisplayBar
                            ...
                            : <Typography variant="h6"> {shouldDisplayName ? 'XP:' + currentValue : currentValue} </Typography>
                        }
                    </Grid>
                )
            ...
            case 'damage':
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        <Typography variant="h6"> {shouldDisplayName ? 'Damage: ' + currentValue : currentValue} </Typography>
                    </Grid>
                )
            ...
            case 'defense':
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        <Typography variant="h6"> {shouldDisplayName ? 'Armor: ' + currentValue : currentValue} </Typography>
                    </Grid>
                )
            ...
            case 'strength':
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        <Typography variant="h6"> {shouldDisplayName ? 'Str: ' + currentValue : currentValue} </Typography>
                    </Grid>
                )
            ...
            case 'dexterity':
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        <Typography variant="h6"> {shouldDisplayName ? 'Dex: ' + currentValue : currentValue} </Typography>
                    </Grid>
                )
            ...
            case 'intelligence':
                return (
                    <Grid item xs={12} className={ justifyContent ? classes.rowJustify : classes.row}>
                        ...
                        <Typography variant="h6"> {shouldDisplayName ? 'Int: ' + currentValue : currentValue} </Typography>
                    </Grid>
                )
